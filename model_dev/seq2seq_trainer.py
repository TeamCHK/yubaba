...
# dataset = datasets.load_dataset('cbt')
...
class Seq2SeqTrainer(Trainer):
    ...
    def _get_lr_scheduler(self, num_training_steps):
        ...
        print(type(self.args.lr_scheduler_type))
        print(arg_to_scheduler.keys())
        print(arg_to_scheduler[self.args.lr_scheduler_type])
        schedule_func = arg_to_scheduler[self.args.lr_scheduler_type]
        if self.args.lr_scheduler_type == "constant":
            scheduler = schedule_func(self.optimizer)
        elif self.args.lr_scheduler_type == "constant_w_warmup":
